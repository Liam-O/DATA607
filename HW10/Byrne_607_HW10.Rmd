...
It was found that the MAXENT model is the most accurate in predicting spam (~96/100 spam emails captured) and should be used in the implementation of a spam filter.
...
# NOTE: WARNING SET TO FALSE ON CHUNK FOR PACKAGE CALLS
...
From the output above, if I were to implement a spam filter for this particular email service, I would go with the `MAXENT` model to use for my filter. Allowing ~5/100 spam emails through is deemed acceptable given the limited corpa. With the ability of users to "flag" emails as spam, tentative training sets could evolve and become more accurate.